...
namespace Areal.SDK.IAP {
    internal class StoreListener : IDetailedStoreListener {
        ...
        private readonly Action<string> _onPurchaseFailed;
        ...
        public void OnPurchaseFailed(Product product, PurchaseFailureReason failureReason) =>
            _onPurchaseFailed($"Purchasing {product.definition.id} failed: {failureReason}");

        public void OnPurchaseFailed(Product product, PurchaseFailureDescription failureDescription) =>
            _onInitializeFailed($"Purchasing {product.definition.id} failed: {failureDescription}");
        ...
        public StoreListener(
            ...
            Action<string> onPurchaseFailed) {
